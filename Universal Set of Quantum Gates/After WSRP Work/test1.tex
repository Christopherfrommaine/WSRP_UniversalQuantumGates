...
After making all of these changes to $\emph{Fig. \ref{fig:classical xor from nand circuit}}$, here is the new implementation of an XOR gate using only modified $2 \to 2$ NAND gates (which also shows the current state at various positions along the circuit, logically simplified as much as possible):
